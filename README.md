...
- **Frontend**: React, Vite, Tailwind CSS, Framer Motion, React-Router, Lucide-React, Recharts, Swiper.js
- **Backend**: Node.js, Netlify Functions, Supabase Auth, JWT, PostgreSQL(Supabase), Bcryptjs, Multer
- **AI/API**: Google Generativa AI, Axios
